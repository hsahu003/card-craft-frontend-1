...
"[project]/app/fabric-editor/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FabricEditorPage({ params }) {
    ...
    const fabricCanvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const textMapRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])({});
    const imageMapRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])({});
    ...
    const [imageStates, setImageStates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            ...
            try {
                const fabric = await __turbopack_context__.A("[project]/node_modules/fabric/dist/index.min.mjs [app-ssr] (ecmascript, async loader)");
                if (disposed) return;
                ...
                const result = await fabric.loadSVGFromString(svgText, (el, obj)=>{
                ...
                const textFieldsLocal = [];
                const textValuesLocal = {};
                const imageZonesLocal = [];
                const imageStatesLocal = {};
                const texts = {};
                const images = {};
                fabricCanvas.getObjects().forEach((obj)=>{
                    const customId = obj.get?.("customId");
                    if (!customId) return;
                    if (customId.startsWith(EDITABLE_PREFIX)) {
                        const label = customId.replace(EDITABLE_PREFIX, "").replace(/_/g, " ");
                        textFieldsLocal.push({
                            id: customId,
                            label
                        });
                        textValuesLocal[customId] = obj.text ?? "";
                        texts[customId] = obj;
                    }
                    if (customId.startsWith(IMAGE_ZONE_PREFIX)) {
                        const label = customId.replace(IMAGE_ZONE_PREFIX, "").replace(/_/g, " ");
                        imageZonesLocal.push({
                            id: customId,
                            label
                        });
                        imageStatesLocal[customId] = {
                            b64: "",
                            scale: 1
                        };
                        images[customId] = obj;
    ...
    const handleTextChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((id, value)=>{
        setTextValues((prev)=>({
                ...prev,
                [id]: value
            }));
    ...
    const handleImageFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((zoneId, file)=>{
        ...
        reader.onload = (re)=>{
            ...
            (async ()=>{
                ...
                const existing = canvas.getObjects().filter((o)=>o.get?.("customImageFor") === zoneId);
                existing.forEach((o)=>canvas.remove(o));
                fabric.FabricImage.fromURL(b64, {
    ...
    const handleImageRemove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((zoneId)=>{
        setImageStates((prev)=>({
                ...prev,
                [zoneId]: {
                    b64: "",
    ...
    const handleZoomChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((zoneId, nextScale)=>{
        setImageStates((prev)=>({
                ...prev,
                [zoneId]: {
                    ...prev[zoneId] || {
        ...
        const canvas = fabricCanvasRef.current;
        if (!canvas) return;
        const imgs = canvas.getObjects().filter((o)=>o.get?.("customImageFor") === zoneId);
        imgs.forEach((img)=>{
            img.scale(nextScale);
        });
        canvas.renderAll();
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$navbar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Navbar"], {}, void 0, false, {
                    fileName: "[project]/app/fabric-editor/[id]/page.tsx",
                    lineNumber: 279,
                    columnNumber: 9
                }, this),
                                                ...
                                                textFields.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            ...
                                                            children: "Click to edit on canvas • Drag to move"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/fabric-editor/[id]/page.tsx",
                                                            lineNumber: 315,
                                                            columnNumber: 23
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                children: hasImage ? "Change image" : "Choose image"
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/app/fabric-editor/[id]/page.tsx",
                                                                                lineNumber: 367,
                                                                                columnNumber: 31
                                                                    ...
                                                                    hasImage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                ...
                                                                                children: "Drag image on canvas to reposition"
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/app/fabric-editor/[id]/page.tsx",
                                                                                lineNumber: 395,
                                                                                columnNumber: 33
...
//# sourceMappingURL=_279c7758._.js.map