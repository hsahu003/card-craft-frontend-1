...
"[project]/app/fabric-editor/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FabricEditorPage({ params }) {
    ...
    const textMapRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({});
    const imageMapRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({});
    ...
    const [imageStates, setImageStates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FabricEditorPage.useEffect": ()=>{
            let disposed = false;
            ({
                "FabricEditorPage.useEffect": async ()=>{
                    ...
                    try {
                        ...
                        const result = await fabric.loadSVGFromString(svgText, {
                            "FabricEditorPage.useEffect": (el, obj)=>{
                        ...
                        objects.forEach({
                            "FabricEditorPage.useEffect": (obj)=>{
                        ...
                        fabricCanvas.on("object:moving", {
                            "FabricEditorPage.useEffect": (e)=>{
                                ...
                                if (id.startsWith(EDITABLE_PREFIX)) {
                                    setTextValues({
                                        "FabricEditorPage.useEffect": (prev)=>({
                                                ...prev,
                                                [id]: target.text
                                            })
                                    }["FabricEditorPage.useEffect"]);
    ...
    const handleTextChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FabricEditorPage.useCallback[handleTextChange]": (id, value)=>{
            setTextValues({
                "FabricEditorPage.useCallback[handleTextChange]": (prev)=>({
                        ...prev,
                        [id]: value
                    })
            }["FabricEditorPage.useCallback[handleTextChange]"]);
    ...
    const handleImageFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FabricEditorPage.useCallback[handleImageFile]": (zoneId, file)=>{
            const reader = new FileReader();
            reader.onload = ({
                "FabricEditorPage.useCallback[handleImageFile]": (re)=>{
                    const b64 = re.target?.result || "";
                    setImageStates({
                        "FabricEditorPage.useCallback[handleImageFile]": (prev)=>({
                                ...prev,
                                [zoneId]: {
                                    b64,
                                    scale: 1
                    ...
                    }["FabricEditorPage.useCallback[handleImageFile]"]);
                    ({
                        "FabricEditorPage.useCallback[handleImageFile]": async ()=>{
                            const fabric = await __turbopack_context__.A("[project]/node_modules/fabric/dist/index.min.mjs [app-client] (ecmascript, async loader)");
                            ...
                            const existing = canvas.getObjects().filter({
                                "FabricEditorPage.useCallback[handleImageFile].existing": (o)=>o.get?.("customImageFor") === zoneId
                            }["FabricEditorPage.useCallback[handleImageFile].existing"]);
                            existing.forEach({
                                "FabricEditorPage.useCallback[handleImageFile]": (o)=>canvas.remove(o)
                            }["FabricEditorPage.useCallback[handleImageFile]"]);
                            fabric.FabricImage.fromURL(b64, {
                                crossOrigin: "anonymous"
                            }).then({
                                "FabricEditorPage.useCallback[handleImageFile]": (img)=>{
                                    img.set({
    ...
    const handleImageRemove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FabricEditorPage.useCallback[handleImageRemove]": (zoneId)=>{
            setImageStates({
                "FabricEditorPage.useCallback[handleImageRemove]": (prev)=>({
                        ...prev,
                        [zoneId]: {
                            b64: "",
                            scale: 1
            ...
            }["FabricEditorPage.useCallback[handleImageRemove]"]);
            const canvas = fabricCanvasRef.current;
            if (!canvas) return;
            const existing = canvas.getObjects().filter({
                "FabricEditorPage.useCallback[handleImageRemove].existing": (o)=>o.get?.("customImageFor") === zoneId
            }["FabricEditorPage.useCallback[handleImageRemove].existing"]);
            existing.forEach({
                "FabricEditorPage.useCallback[handleImageRemove]": (o)=>canvas.remove(o)
            }["FabricEditorPage.useCallback[handleImageRemove]"]);
            canvas.renderAll();
    ...
    const handleZoomChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FabricEditorPage.useCallback[handleZoomChange]": (zoneId, nextScale)=>{
            setImageStates({
                "FabricEditorPage.useCallback[handleZoomChange]": (prev)=>({
                        ...prev,
                        [zoneId]: {
                            ...prev[zoneId] || {
                                b64: ""
            ...
            }["FabricEditorPage.useCallback[handleZoomChange]"]);
            const canvas = fabricCanvasRef.current;
            if (!canvas) return;
            const imgs = canvas.getObjects().filter({
                "FabricEditorPage.useCallback[handleZoomChange].imgs": (o)=>o.get?.("customImageFor") === zoneId
            }["FabricEditorPage.useCallback[handleZoomChange].imgs"]);
            imgs.forEach({
                "FabricEditorPage.useCallback[handleZoomChange]": (img)=>{
                    img.scale(nextScale);
                }
            }["FabricEditorPage.useCallback[handleZoomChange]"]);
            canvas.renderAll();
    ...
    const handleExportPDF = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FabricEditorPage.useCallback[handleExportPDF]": async ()=>{
            const canvas = fabricCanvasRef.current;
            if (!canvas) return;
            setIsExporting(true);
            try {
                ...
                const pxToMm = {
                    "FabricEditorPage.useCallback[handleExportPDF].pxToMm": (px)=>px * 25.4 / 96
                }["FabricEditorPage.useCallback[handleExportPDF].pxToMm"];
    ...
    }["FabricEditorPage.useCallback[handleExportPDF]"], [
        template.name
    ]);
    const handleAddToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FabricEditorPage.useCallback[handleAddToCart]": ()=>{
            const canvas = fabricCanvasRef.current;
            let customMessage = "";
            if (canvas) {
                const dataUrl = canvas.toDataURL({
...
_s(FabricEditorPage, "WCHMyk1vIafo5P28ubA2XAXeVV4=", false, function() {
    return [
...
_c = FabricEditorPage;
var _c;
__turbopack_context__.k.register(_c, "FabricEditorPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_c95daa65._.js.map