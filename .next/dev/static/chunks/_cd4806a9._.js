...
"[project]/components/editor/fabric-card-canvas.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const EDITABLE_ID_PREFIX = "editable_";
const IMAGE_ZONE_ID_PREFIX = "image_zone_";
function collectAllObjects(obj, list) {
    if (!obj || typeof obj !== "object") return;
    const o = obj;
    if (typeof o.getObjects === "function") {
        o.getObjects().forEach((child)=>collectAllObjects(child, list));
    } else {
        list.push(obj);
    }
}
function findGroupContaining(obj, target) {
    if (typeof obj.getObjects !== "function") return null;
    const g = obj;
    if (g.getObjects().includes(target)) return g;
    for (const child of g.getObjects()){
        const found = findGroupContaining(child, target);
        if (found) return found;
    }
    return null;
}
function findParent(canvas, target) {
    for (const obj of canvas.getObjects()){
        if (obj === target) return null;
        const g = findGroupContaining(obj, target);
        if (g) return g;
    }
    return null;
}
function FabricCardCanvas({ svgUrl, containerClassName = "" }) {
    _s();
    const wrapperRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const canvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const fabricCanvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const fileInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const lastImageZoneRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const setupImageZoneClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FabricCardCanvas.useCallback[setupImageZoneClick]": (canvas)=>{
            ...
            input.onchange = ({
                "FabricCardCanvas.useCallback[setupImageZoneClick]": ()=>{
                    const file = input.files?.[0];
                    if (!file || !lastImageZoneRef.current) return;
                    const url = URL.createObjectURL(file);
                    __turbopack_context__.A("[project]/node_modules/fabric/dist/index.min.mjs [app-client] (ecmascript, async loader)").then({
                        "FabricCardCanvas.useCallback[setupImageZoneClick]": (fabric)=>{
                            fabric.FabricImage.fromURL(url, {
                                crossOrigin: "anonymous"
                            }).then({
                                "FabricCardCanvas.useCallback[setupImageZoneClick]": (img)=>{
                                    const zone = lastImageZoneRef.current;
                                    if (!zone || !canvas) return;
                                    const zoneRect = zone.getBoundingRect(true);
                                    img.set({
                                        left: zoneRect.left,
                                        top: zoneRect.top,
                                        scaleX: zoneRect.width / (img.width || 1),
                                        scaleY: zoneRect.height / (img.height || 1),
                                        selectable: true,
                                        evented: true
                                    });
                                    canvas.add(img);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FabricCardCanvas.useEffect": ()=>{
            const wrapper = wrapperRef.current;
            const canvasEl = canvasRef.current;
            if (!wrapper || !canvasEl || !svgUrl) return;
            let fabricCanvas = null;
            const init = {
                "FabricCardCanvas.useEffect.init": async ()=>{
                    const fabric = await __turbopack_context__.A("[project]/node_modules/fabric/dist/index.min.mjs [app-client] (ecmascript, async loader)");
                    const width = wrapper.offsetWidth || 400;
                    const height = wrapper.offsetHeight || 533;
                    ...
                    const svgText = await fetch(svgUrl).then({
                        "FabricCardCanvas.useEffect.init": (r)=>r.text()
                    }["FabricCardCanvas.useEffect.init"]);
                    const reviver = {
                        "FabricCardCanvas.useEffect.init.reviver": (element, fabricObject)=>{
                            const id = element.getAttribute?.("id");
                            if (id) fabricObject.set("name", id);
                        }
                    }["FabricCardCanvas.useEffect.init.reviver"];
                    const result = await fabric.loadSVGFromString(svgText, reviver);
                    ...
                    const allObjs = [];
                    fabricCanvas.getObjects().forEach({
                        "FabricCardCanvas.useEffect.init": (obj)=>collectAllObjects(obj, allObjs)
                    }["FabricCardCanvas.useEffect.init"]);
                    for (const obj of allObjs){
                        const name = obj.name;
                        if (!name) continue;
                        if (name.startsWith(EDITABLE_ID_PREFIX)) {
                            const textObj = obj;
                            const hasText = "text" in textObj && typeof textObj.text === "string";
                            if (!hasText) continue;
                            ...
                            const parent = findParent(fabricCanvas, obj);
                            if (parent) {
                                parent.remove(obj);
                                parent.add(iText);
                            } else {
                        ...
                        if (name.startsWith(IMAGE_ZONE_ID_PREFIX)) {
                            obj.set({
                                selectable: false,
                                evented: true
                            });
                    ...
                    setupImageZoneClick(fabricCanvas);
                }
            }["FabricCardCanvas.useEffect.init"];
            init();
            const ro = new ResizeObserver({
                "FabricCardCanvas.useEffect": ()=>{
                    if (fabricCanvasRef.current && wrapperRef.current) {
                        const w = wrapperRef.current.offsetWidth;
                        const h = wrapperRef.current.offsetHeight;
                        if (w && h) fabricCanvasRef.current.setDimensions({
                            width: w,
                            height: h
                        });
                    }
            ...
            return ({
                "FabricCardCanvas.useEffect": ()=>{
                    ro.disconnect();
                    if (fileInputRef.current?.parentNode) fileInputRef.current.parentNode.removeChild(fileInputRef.current);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("canvas", {
            ...
            fileName: "[project]/components/editor/fabric-card-canvas.tsx",
            lineNumber: 200,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
_s(FabricCardCanvas, "PvZq7tc4TPgI8Isz9huL0+AURwI=");
_c = FabricCardCanvas;
var _c;
__turbopack_context__.k.register(_c, "FabricCardCanvas");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$editor$2f$fabric$2d$card$2d$canvas$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/editor/fabric-card-canvas.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function EditorPage({ params }) {
    ...
    const [message, setMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Your Message Here");
    const [recipientName, setRecipientName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Recipient Name");
    const [fontFamily, setFontFamily] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Inter");
    ...
    const [textColor, setTextColor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("#1a1a2e");
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "relative flex aspect-[3/4] w-full max-w-md flex-col items-center justify-center overflow-hidden rounded-xl shadow-lg bg-white",
                                        style: !template.svg ? {
                                            background: `linear-gradient(135deg, ${template.colors[0]} 0%, ${template.colors[1]} 100%)`
                                        } : undefined,
                                        children: template.svg ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$editor$2f$fabric$2d$card$2d$canvas$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FabricCardCanvas"], {
                                            svgUrl: template.svg,
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mx-8 w-full max-w-xs cursor-text rounded-lg border-2 border-dashed border-foreground/30 bg-card/80 p-4 backdrop-blur-sm",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mx-8 mt-4 w-full max-w-xs cursor-text rounded-lg border-2 border-dashed border-foreground/30 bg-card/80 p-3 backdrop-blur-sm",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: template.svg ? "Click an image zone on the card (id starts with image_zone_) to add a photo." : "Upload or click image zones on the card when using an SVG template."
                                                }, void 0, false, {
                                                    fileName: "[project]/app/editor/[id]/page.tsx",
                                                    lineNumber: 303,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-input p-6 transition-colors hover:border-primary",
                                                    children: [
...
_s(EditorPage, "gY4jMAKcFnlzITTxX0Idg1Ybo40=", false, function() {
    return [
...
//# sourceMappingURL=_cd4806a9._.js.map