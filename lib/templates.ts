...
export const allTemplates: Template[] = [
  ...
  { id: "12", name: "Winter Wonderland", category: "Wedding", language: "hindi", price: 99, colors: ["#F0F9FF", "#38BDF8"], emoji: "❄️", svg: "/assets/cards/greeting-card-12.svg", thumbnail: "/assets/cards/thumbnails/greeting-card-12.png", theme: "Palace", culture: "Hindu" },
