...
export const allTemplates: Template[] = [
  ...
  { id: "11", name: "Wedding Invitation Peacock", category: "Wedding", price: 99, colors: ["#FCE7F3", "#DB2777"], emoji: "🌸", svg: "/assets/cards/greeting-card-11.svg" },
  { id: "12", name: "Winter Wonderland", category: "Holiday", price: 99, colors: ["#F0F9FF", "#38BDF8"], emoji: "❄️", svg: "/assets/cards/greeting-card-12.svg" },
]
